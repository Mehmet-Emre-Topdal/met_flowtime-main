                ...
                {isComplete ? (
                    ...
                    <div className="flex gap-1.5">
                        <button
                            ...
                            className="w-7 h-7 rounded-lg border border-[#e6e6ec] bg-[#ffffff] text-[#5d5d68] text-lg leading-none flex items-center justify-center hover:bg-[#f4f4f7] transition-colors"
                        ...
                        <button
                            onClick={() => setRemaining(remaining - 1)}
                            className="w-7 h-7 rounded-lg bg-[#7c6cd4] text-white text-lg leading-none flex items-center justify-center hover:brightness-95 transition-all"
